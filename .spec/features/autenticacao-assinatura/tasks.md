...
- Arquivos: backend/src/auth/auth.controller.ts, backend/src/auth/auth.service.ts, backend/src/auth/auth.module.ts, backend/src/auth/dto/login.dto.ts, backend/src/auth/dto/register.dto.ts, backend/src/users/users.service.ts, backend/src/users/users.controller.ts, backend/src/users/users.module.ts
- Esforço: medio
